...
def main():
    ...
    models_dir = os.path.join(current_dir, "src\Projet\Models")
    
    # Définir les chemins vers les applications Streamlit 
    # vu que le modèle pour les rapports finnaciers marche pour la plupart des use cases, on va l'utiliser principalement
